            ...
            if (data.code == 0) {
                ...
                if (isNotNull(data.data.data)) {
                    ...
                    data.data.data.forEach(function (val, index) {
                        ab = ab + writeData([val.partnerName, val.productId, "<img src='" + val.productCoverImage + "' width='100px' />", val.productName, val.productModel, val.productTypeName, val.salePrice,
