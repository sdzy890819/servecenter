package com.fdz.job.controller;
...
public class QuartzJobDetailController {
    ...
    @ApiOperation("添加Push任务Job")
    @PostMapping("/push")
    public ResponseEntity<Boolean> addPushJob(@RequestBody @Valid PushJobDto pushJobDto) {
        JobDetailDO jobDetailDO = cronExpressionService.genCronExpressionByPushJobDto(pushJobDto);
        boolean result = quartzJobDetailService.add(jobDetailDO);
